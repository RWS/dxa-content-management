...
<html id="dxa-cr-settings-dialog" class="popup" xmlns="http://www.w3.org/1999/xhtml">
    <head>
		<title>
		    <asp:Literal runat="server" Text="<%$ Resources: DXA.CM.Extensions.DXAResolver.Editors.Strings, CR_EditDXASettingsDialogTitle %>" />
		</title>
                                ...
                                <div class="dxa-field __horizontal">
                                    <div class="dxa-field_label">
                                        <label for="CR_RecurseDepth" class="__required">
                                            <asp:Literal runat="server" Text="<%$ Resources: DXA.CM.Extensions.DXAResolver.Editors.Strings, CR_RecurseDepth %>" />
                                        </label>
                                        <div class="dxa-field_hint">
                                            <asp:Literal runat="server" Text="<%$ Resources: DXA.CM.Extensions.DXAResolver.Editors.Strings, CR_RecurseDepthHint %>" />
                                        </div>
                                    </div>
                        ...
                        <div class="dxa-layout_column __side_right">
                            <div class="dxa-layout_reducer">
                                <div class="dxa-buttons">
                                    <c:Button ID="BtnSave" runat="server" Label="<%$ Resources: DXA.CM.Extensions.DXAResolver.Editors.Strings, CR_Save %>" />
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div id="BottomPanel" class="dxa-layout_element __footer">
                <div class="dxa-layout_reducer">
                    <div class="dxa-button_group __move_right">
                        <c:Button ID="BtnClose" runat="server" Label="<%$ Resources: DXA.CM.Extensions.DXAResolver.Editors.Strings, CR_Close %>" />
                    </div>
