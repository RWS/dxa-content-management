...
>
    <!-- 
      ...
      Version 2.0 (Quirijn Slings 23 Feb 2015)      
      Removed the functionality to remove publications and folders, because this is handled in the DynamicPage/DynamicComponent templates already
      and controlled with the package parameters OmitOwningPublications, OmitContextPublications, OmitFolders
