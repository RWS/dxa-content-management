...
namespace DD4T.Templates
{
    ...
    /// Note: the implementer is responsible for creating an endpoint in the web application which receives DD4T page data in the body of
    ///       a POST request. The URL of this endpoint must be configured in a file called DD4T.config, in the Tridion config folder.
    ///       Format of this file:
    ///       <?xml version="1.0"?>
    ///       <configuration>
    ///         <appSettings>
